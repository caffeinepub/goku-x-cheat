...
export class Backend implements backendInterface {
    ...
    async generateVerificationCode(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateVerificationCode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyCode(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
